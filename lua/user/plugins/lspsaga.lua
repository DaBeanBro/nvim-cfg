return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "M", "<cmd>Lspsaga code_action<cr>", { silent = true, noremap = true, desc = "Code Action" })
    ...
    vim.keymap.set("n", "<leader>ls", "<cmd>Lspsaga signature_help<CR>",
    ...
    vim.keymap.set("n", "<leader>o", "<cmd>Lspsaga outline<CR>", { silent = true, noremap = true, desc = "Outline" })
